<template>
	<div class="flex relative" v-click-outside="onClickOutside" @mouseover="hovering = true" @mouseleave="hovering = false">
		...
		<div
			...
			class="menu order-first flex flex-col lg:flex-row absolute right-0 top-full bg-white z-40 lg:items-center align-items-center p-3 rounded-lg shadow-lg border border-1"
		>
			<slot></slot>
		</div>
	</div>
